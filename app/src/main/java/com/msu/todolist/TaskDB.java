...
public class TaskDB  {
    ...
    public static boolean update(DatabaseHelper dbHelper, String taskId, String taskCategory, String taskName, String taskDetails, String taskDate, String taskTime, String taskStatus) {
        ContentValues contentValues = new ContentValues( );
        contentValues.put(TASK_CATEGORY, taskCategory);
        contentValues.put(TASK_NAME, taskName);
        contentValues.put(TASK_DETAILS, taskDetails);
